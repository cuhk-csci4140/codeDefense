...
Lightwall.prototype.execute = function(caster, onComplete) {
	...
	this.world.services[CombatService.NAME].callLater(5, (function() {
		this.finish();
	}).bind(this));

};

Lightwall.prototype.finish = function() {
