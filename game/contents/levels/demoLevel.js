...
demoLevel.prototype.initialize = function() {
	...
	for (var i = 6; i <= 11; i++) {
		...
		if (rand > 0.5) {
			...
			this.get('bori' + i).sprite.setTransform(70 + 120 * i,
					60 * (i - 6), // 70
					-0.7, 0.7);
			this.get('bori' + i).hpBar.setTransform(35 + 120 * i,
					(120 * (i - 6)) + 10, 0.6, 0.6);
			...
			this.get('chibi' + i).sprite.setTransform(30 + 120 * i, -30
					* (i - 6), -0.6, 0.6);
			this.get('chibi' + i).hpBar.setTransform(35 + 120 * i,
					(120 * (i - 6)) + 10, 0.6, 0.6);
